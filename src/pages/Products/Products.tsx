        ...
        <div className="products-section">
          ...
          <div className="product-section__bottom">
                ...
                <div className="products-section__right-filter-accordion">
                  <Accordion elevation={0}>
                    <AccordionSummary
                      ...
                      id="panel1-header"
                    >
                      <Typography component="span" className="products-accordion__title">قیمت</Typography>
                    </AccordionSummary>
                    <AccordionDetails sx={{ padding: 0 }}>
                      <div className="products-section__accordion-price">
                        <div className="products-section__accordion-price-max">
                          <span>بیشترین</span>
                          <input type="text" placeholder="وارد کنید" onChange={(e) => handleInputChange(1, e.target.value)} value={value[1].toLocaleString()} />
                        </div>
                        <div className="products-section__accordion-price-min">
                          <span>کمترین</span>
                          <input type="text" placeholder="وارد کنید" onChange={(e) => handleInputChange(0, e.target.value)} value={value[0].toLocaleString()} />
                        </div>
                        <Box sx={{ width: '100%' }}>
                          <Slider
                            value={value}
                  ...
                  <Accordion elevation={0}>
                    <AccordionSummary
                      ...
                      id="panel2-header"
                    >
                      <Typography component="span" className="products-accordion__title">رنگ</Typography>
                    </AccordionSummary>
                    <AccordionDetails sx={{ padding: 0 }}>
                  ...
                  <Accordion elevation={0} sx={{ padding: 0 }}>
                    <AccordionSummary
                      ...
                      id="panel2-header"
                    >
                      <Typography component="span" className="products-accordion__title">سایز</Typography>
                    </AccordionSummary>
                    <AccordionDetails>
                      <div className="products-section__accordion-size">
                        <button className="products-section__accordion-size-btn">L</button>
                        <button className="products-section__accordion-size-btn">M</button>
                        <button className="products-section__accordion-size-btn">S</button>
                        <button className="products-section__accordion-size-btn">XL</button>
                        <button className="products-section__accordion-size-btn">XXL</button>
                      </div>
                    </AccordionDetails>
                  </Accordion>
                  <Accordion elevation={0}>
                    <AccordionSummary
                      ...
                      id="panel2-header"
                    >
                      <Typography component="span" className="products-accordion__title">برند</Typography>
                    </AccordionSummary>
                    <AccordionDetails sx={{ padding: 0 }}>
                      <div className="products-section__filter-brand">
                        ...
                        <div className="products-section__filter-brand-btns">
                          <button className="products-section__filter-brand-btn">The North Face</button>
                          <button className="products-section__filter-brand-btn">Under Armour</button>
                          <button className="products-section__filter-brand-btn">nike</button>
                          <button className="products-section__filter-brand-btn">nike</button>
                          <button className="products-section__filter-brand-btn">Fila</button>
                          <button className="products-section__filter-brand-btn">adidas</button>
                          <button className="products-section__filter-brand-btn">Fila</button>
                          <button className="products-section__filter-brand-btn">adidas</button>
                          <button className="products-section__filter-brand-btn">Under Armour</button>
                        </div>
            ...
            <div className="products-section__pagination">
              ...
              <Stack spacing={2} style={{ alignSelf: 'center', marginTop: '32px' }}>
                <Pagination
                  count={pageCount}
                  page={page}
                  onChange={(e, value) => {
