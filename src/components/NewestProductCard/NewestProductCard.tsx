...
export default function NewestProductCard({ img }: Image) {
  return (
    <div className="newest-product__card">
      <div className="newest-product__card-overlay">
        <div className="newest-product__card-overlay-wrapper">
          <h2 className="newest-product__card-overlay-title">
            فقط با یک کلیک وارد دنیای محصولات جدید شوید
          </h2>
          <Link to={"./products"}>
            <button className="newest-product__card-overlay-btn">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
      ...
      <div className="newest-product__card-title">
        ...
        <div className="newest-product__card-title-content">
          ...
          <h2 className="newest-product__card-title-text">
            <span className="newest-product__card-title-text-sapn">۵۰ ٪</span>{" "}
            تخفیف روی تمام محصولات{" "}
          </h2>
        </div>
      </div>
      <div className="newest-product__card-overlay-content"></div>
    </div>
  );
}
